    ...
    <body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">Game List - Nedas Kakta</p>
        ...
        <section class="page-section portfolio" id="portfolio">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0" id="portfolio-fill">Portfolio</h2>
                <!-- Icon Divider-->
                ...
                <div class="row justify-content-center" id="fill-this-bad-boi">
                    <!-- Portfolio Item 1-->
                    ...
                    <div class="col-md-6 col-lg-4 mb-5">
                        <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal3">
                            ...
                            <img class="img-fluid" src="{{asset('portfolio/circus.png')}}" alt="" />
                        </div>
                    </div>
                    <!-- Portfolio Item 4-->
            ...
            function loadDoc() {
                ...
                xhttp.onreadystatechange = function() {
                    ...
                    if (this.readyState == 4 && this.status == 200) {
                        document.getElementById("fill-this-bad-boi").innerHTML = this.responseText;
                        document.getElementById("portfolio-fill").innerHTML = 'Game list';
                    }
                };
                xhttp.open("GET", "http://localhost:8080/api/v1/game", true);
                xhttp.send();
            }
        </script>
    </body>
